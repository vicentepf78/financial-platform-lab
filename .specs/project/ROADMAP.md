...
**Gestão de Clientes** - [create-customer](../features/create-customer/spec.md) ✅ DONE · [query-customers](../features/query-customers/spec.md) ✅ DONE · [update-customer](../features/update-customer/spec.md) ✅ DONE
